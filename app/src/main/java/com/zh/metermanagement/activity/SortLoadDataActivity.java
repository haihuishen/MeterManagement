 ...
 * 功能选择界面
 */
public class SortLoadDataActivity extends BaseActivity implements OnClickListener {
	...
	private int[] mLayoutIds = {
			R.id.layout_noWorkOrder, 			// 无工单
			R.id.layout_haveWorkOrder,			// 有工单
	...
	public int getContentLayout() {
		return R.layout.activity_sort_load_data;
	}
	...
	public void initData() {
		...
		mTvTitle.setText("导入类型");

		mLayoutList = new ArrayList<LinearLayout>();
		LinearLayout layout = null ;

		for(int i = 0; i < mLayoutIds.length ; i++){			// 获取控件
			...
			public void onAnimationEnd(Animation animation) {
				...
				switch (view.getId()) {
					...
					case R.id.layout_noWorkOrder:							// 无工单
						...
						intent = new Intent(SortLoadDataActivity.this, LoadDataActivity1.class);
